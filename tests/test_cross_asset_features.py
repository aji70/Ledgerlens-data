...
def test_counterparty_overlap_high_for_shared_counterparties():
    ...
    trades = pd.DataFrame([
        {"trade_id": "1", "ledger_close_time": "2024-01-01T00:00:00Z",
         "base_account": "A", "counter_account": "CP1",
         "base_asset": "USDC:issuer", "counter_asset": "XLM:native",
         "amount": 100.0, "pair_id": "pair1"},
        {"trade_id": "2", "ledger_close_time": "2024-01-01T00:01:00Z",
         "base_account": "A", "counter_account": "CP2",
         "base_asset": "USDC:issuer", "counter_asset": "XLM:native",
         "amount": 100.0, "pair_id": "pair1"},
        {"trade_id": "3", "ledger_close_time": "2024-01-01T00:02:00Z",
         "base_account": "A", "counter_account": "CP3",
         "base_asset": "USDC:issuer", "counter_asset": "XLM:native",
         "amount": 100.0, "pair_id": "pair1"},
        {"trade_id": "4", "ledger_close_time": "2024-01-01T00:03:00Z",
         "base_account": "CP1", "counter_account": "A",
         "base_asset": "BTC:issuer", "counter_asset": "XLM:native",
         "amount": 50.0, "pair_id": "pair2"},
        {"trade_id": "5", "ledger_close_time": "2024-01-01T00:04:00Z",
         "base_account": "CP2", "counter_account": "A",
         "base_asset": "BTC:issuer", "counter_asset": "XLM:native",
         "amount": 50.0, "pair_id": "pair2"},
        {"trade_id": "6", "ledger_close_time": "2024-01-01T00:05:00Z",
         "base_account": "CP3", "counter_account": "A",
         "base_asset": "BTC:issuer", "counter_asset": "XLM:native",
         "amount": 50.0, "pair_id": "pair2"},
    ])
    features = compute_cross_asset_features("A", trades)
...
def test_counterparty_overlap_zero_for_disjoint():
    ...
    trades = pd.DataFrame([
        ...
        {"trade_id": "3", "ledger_close_time": "2024-01-01T00:02:00Z",
         ...
         "amount": 50.0, "pair_id": "pair2"},
        {"trade_id": "4", "ledger_close_time": "2024-01-01T00:03:00Z",
         "base_account": "CP4", "counter_account": "A",
         "base_asset": "BTC:issuer", "counter_asset": "XLM:native",
         "amount": 50.0, "pair_id": "pair2"},
    ])
    features = compute_cross_asset_features("A", trades)
...
def test_synthetic_dataset_includes_cross_asset_columns():
    ...
    for col in expected_cols:
        if col != "cross_pair_mad_std":  # Skip MAD std which might have less variance
            ...
            assert abs(label_0_mean - label_1_mean) > 0.01, \
...
def test_missing_timestamps():
    ...
    trades = pd.DataFrame([
        {"trade_id": "1", "ledger_close_time": pd.NaT,
         "base_account": "A", "counter_account": "B",
         "base_asset": "USDC:issuer", "counter_asset": "XLM:native",
         "amount": 100.0, "pair_id": "pair1"},
        {"trade_id": "2", "ledger_close_time": "2024-01-01T00:00:00Z",
         "base_account": "A", "counter_account": "C",
         "base_asset": "BTC:issuer", "counter_asset": "XLM:native",
         "amount": 100.0, "pair_id": "pair2"},
    ])
